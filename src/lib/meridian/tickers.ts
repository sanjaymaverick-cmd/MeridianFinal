...
export const TICKERS: Record<string, TickerMap> = {
  ...
  POL: binance("POLUSDT", "POL-USD"),
  STX: binance("STXUSDT", "STX-USD"),
  IMX: binance("IMXUSDT", "IMX-USD"),
  GRT: binance("GRTUSDT", "GRT-USD"),
  LDO: binance("LDOUSDT", "LDO-USD"),
  CRV: binance("CRVUSDT", "CRV-USD"),
  SAND: binance("SANDUSDT", "SAND-USD"),
  ALGO: binance("ALGOUSDT", "ALGO-USD"),
  VET: binance("VETUSDT", "VET-USD"),
  JUP: binance("JUPUSDT", "JUP-USD"),
  PYTH: binance("PYTHUSDT", "PYTH-USD"),
  PENDLE: binance("PENDLEUSDT", "PENDLE-USD"),
  FLOKI: binance("FLOKIUSDT", "FLOKI-USD"),
  ORDI: binance("ORDIUSDT", "ORDI-USD"),
  CAKE: binance("CAKEUSDT", "CAKE-USD"),
  ENS: binance("ENSUSDT", "ENS-USD"),
  APE: binance("APEUSDT", "APE-USD"),
  GALA: binance("GALAUSDT", "GALA-USD"),
  CHZ: binance("CHZUSDT", "CHZ-USD"),
  THETA: binance("THETAUSDT", "THETA-USD"),
  W: binance("WUSDT", "W-USD"),
  STRK: binance("STRKUSDT", "STRK-USD"),
  WIF: binance("WIFUSDT", "WIF-USD"),
  BONK: binance("BONKUSDT", "BONK-USD"),
