...
const REASON_PART: Record<string, string> = {
  farm: "Farm",
  pnl: "PnL sleeve",
  pred: "paper prediction",
  btc5m: "BTC 5m Up/Down",
  yes: "YES (Up)",
  no: "NO (Down)",
  quote_unavailable: "quote unavailable",
  pred_paused: "pause — no new predictions",
  pred_settle: "window settled",
  pred_no_reverse: "paper prediction — no reverse",
  live: "paper quote",
  paper: "paper quote",
  ...
  reverse_operator: "reversed by you",
  no_open_clip: "no open clip on that name",
  bad_price: "no live price",
